...
import { createArtwork, getArtwork } from "../services/artwork";
...
const CreateArtworkFrom = () => {
  ...
  // console.log("serializedGlobals", serializedGlobals);
...
CreateArtworkFrom.action = action;
CreateArtworkFrom.loader = loader;

export default CreateArtworkFrom;
